        ...
        <div className="footer_row row">
          <div className="col-lg-4 col-md-12 col-sm-12 col-12 footer_col4_1 mb-3">
            ...
            <p>
              ...
              commodi deserunt distinctio fugiat harum id ipsum, iusto libero
              odio officia pariatur perspiciatis suscipit, ullam. Aliquid ex
              ipsam nihil provident quae?
            </p>
          </div>
            ...
            <ul className="navbar-nav">
              <li className="nav-item">
                ...
                >
                  ...
                  sardornarzikulov2002@gmail.com
                </a>
              </li>
              <li className="nav-item">
                <a
                  target="_blank"
                  href="tel:+998995552446"
                  className="nav-link"
                  rel='noreferrer'
                >
                  <span>
              ...
              <li className="nav-item">
                ...
                >
                  ...
                  Tashkent, Yashnabot tumani, Ko'prikli ko'chasi, 816-xona
                </a>
              </li>
            </ul>
          </div>
